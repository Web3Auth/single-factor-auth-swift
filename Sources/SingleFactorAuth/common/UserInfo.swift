//TODO: Contents of common folder must move to a common dependency
import Foundation
...
public class UserInfo: Codable {
    ...
    public init(email: String, name: String, profileImage: String, aggregateVerifier: String? = nil, verifier: String, verifierId: String, typeOfLogin: LoginType, ref: String? = nil, // extraVerifierParams: PassKeyExtraParams? = nil,
        accessToken: String? = nil, idToken: String? = nil, extraParams: String? = nil, extraParamsPassed: String? = nil, state: TorusGenericContainer) {
        self.email = email
        self.name = name
